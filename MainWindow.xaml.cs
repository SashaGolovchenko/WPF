...
namespace WpfApp1
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void LoadCustomersFromXml()
        {
            ...
            {
                MessageBox.Show($"Ошибка загрузки станков из XML: {ex.Message}", "Ошибка", MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
        ...
        private void SaveCustomersToXml()
        {
            try
            {
                ...
                MessageBox.Show("Станки успешно сохранены в XML файл.", "Успех", MessageBoxButton.OK, MessageBoxImage.Information);
            }
            catch (Exception ex)
            {
                MessageBox.Show($"Ошибка сохранения станков в XML: {ex.Message}", "Ошибка", MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
